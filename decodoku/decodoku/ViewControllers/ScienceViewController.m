...
- (void)makeButtons {
    ...
    _text.frame = CGRectMake(0.05 * wS, 0.2 * hS, 0.85*wS, 0.0); // frame
    _text.text = [NSString stringWithFormat:NSLocalizedString(@"science", nil), @(1000000)]; // text
    _text.textColor = [UIColor blackColor]; //text colour
    _text.font = [UIFont fontWithName:@"QuicksandBook-Regular" size:MAX(0.035 * wS,14)]; // text font
...
- (IBAction)menuButton:(id)sender {
    ...
    [self performSegueWithIdentifier:@"fromScience" sender:self];
